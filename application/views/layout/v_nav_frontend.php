  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="<?= base_url() ?>" class="navbar-brand">
        ...
        <span class="brand-text font-weight-light"><b>Koperasi UMKM</b></span>
      </a>
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <?php if (empty($keranjang)) { ?>
              ...
              <a  href="<?= base_url('belanja/cekout') ?>" class="dropdown-item dropdown-footer">Chech Out</a>
            <?php } ?>
            <!-- BARANG End -->
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Koperasi UMKM</a></li>
