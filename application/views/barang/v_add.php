    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input name="harga" type="text" class="form-control" placeholder="Harga Barang" value="<?= set_value('harga') ?>">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>Berat Barang (Gr)</label>
                        <input type="number" name="berat" type="text" min="0" class="form-control" placeholder="Berat Dalam Satuan Gram" value="<?= set_value('berat') ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" class="form-control" rows="7" placeholder="Deskripsi Barang" <?= set_value('deskripsi') ?>></textarea>
            </div>
